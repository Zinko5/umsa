public class ColaSimpleComunidades {
    private int max = 20;
    private int ini, fin;
    private Comunidad v[] = new Comunidad[max + 1];

    public ColaSimpleComunidades() {
        ini = fin = 0;
    }
    ...
    public void mostrar ()
    {
        ...
        else
        {
            ...
            ColaSimpleComunidades aux = new ColaSimpleComunidades ();
            while (!esvacia ())
            {
    ...
    public void vaciar (ColaSimpleComunidades a)
    {
            while (!a.esvacia ())
