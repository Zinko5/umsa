public class App {
    public static void main(String[] args) {
        ...
        listaDobleInscritos3.adiFinal(10, "Pedro", 1, 1, 45);
        listaDobleInscritos3.adiFinal(11, "Juan", 2, 7, 98);
        listaDobleInscritos3.adiFinal(12, "Jose", 3, 9, 45);
        listaDobleInscritos3.adiFinal(13, "Fernando", 4, 13, 47);
        listaDobleInscritos3.adiFinal(14, "Francisco", 4, 15, 65);
        
        listaDobleInscritos4.adiFinal(15, "Maria", 1, 3, 75);
        listaDobleInscritos4.adiFinal(16, "Jorge", 1, 3, 18);
        listaDobleInscritos4.adiFinal(17, "Isac", 2, 5, 48);
        listaDobleInscritos4.adiFinal(18, "Lucas", 2, 6, 28);
        
        listaDobleInscritos5.adiFinal(19, "Pedro", 1, 1, 85);
        listaDobleInscritos5.adiFinal(20, "Juan", 2, 6, 64);
        listaDobleInscritos5.adiFinal(21, "Jose", 2, 6, 76);
        listaDobleInscritos5.adiFinal(22, "Fernando", 2, 8, 28);
        listaDobleInscritos5.adiFinal(23, "Francisco", 3, 10, 45);
        
        listaDobleInscritos6.adiFinal(24, "Maria", 1, 4, 70);
        listaDobleInscritos6.adiFinal(25, "Jorge", 2, 7, 68);
        listaDobleInscritos6.adiFinal(26, "Isac", 3, 12, 47);
        listaDobleInscritos6.adiFinal(27, "Lucas", 4, 12, 64);
        
        listaDobleInscritos7.adiFinal(28, "Maria", 1, 2, 88);
        listaDobleInscritos7.adiFinal(29, "Jorge", 1, 3, 74);
        listaDobleInscritos7.adiFinal(30, "Isac", 3, 11, 38);
        listaDobleInscritos7.adiFinal(31, "Lucas", 4, 12, 41);
        ...
        //mostrar del departamento x a los inscritos
