 ...
 * @author gabriel
 */
public class ModificarEventoMenu extends javax.swing.JFrame {
    ...
    public ModificarEventoMenu() {
        initComponents();
        this.e1 = e1;
        this.e2 = e2;
    }
    public ModificarEventoMenu(EspacioMunicipalCultural e1, EspacioMunicipalCultural e2) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModificarEventoMenu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModificarEventoMenu().setVisible(true);
            }
        });
    }
