...
stop_words_es = set(stopwords.words('spanish'))  # Stopwords en español: 'el', 'en', 'y', 'de', etc.
...
def limpiar_texto(texto):
    ...
    texto = ' '.join([word for word in texto.split() if word not in stop_words_es])  # Elimina stopwords
    return texto
