...
#let fechaEntrega = datetime(year: 2025, month: 3, day: 17)
...
#show grid:box
= Instalación y despliegue de MongoDB
== mongosh y mongod:
#image("../media/imongodb.png")
== MongoDB Compass:
#image("../media/imongodb2.png")
== Creación de colección:
#image("../media/2mongodb.png")
