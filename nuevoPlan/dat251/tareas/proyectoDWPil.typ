...
dimTtiempo.ktr:
#image("../media/proy17.png")
Configuraciones:
#grid(
  columns: (auto,auto),
  [#image("../media/proy171.png")],[#image("../media/proy172.png")]
)
Configuraciones similares se aplican a cada transformación.
dimTtiempo.ktr:
#image("../media/proy17.png")
dimLinea.ktr:
#image("../media/proy18.png")
dimMaquina.ktr:
#image("../media/proy19.png")
dimOperario.ktr:
#image("../media/proy110.png")
dimProducto.ktr:
#image("../media/proy111.png")
hProduccion.ktr:
#image("../media/proy112.png")
Configuraciones:
#grid(
  columns: (auto,auto),
  [#image("../media/proy1121.png")],[#image("../media/proy1122.png")],
  [#image("../media/proy1123.png")],[#image("../media/proy1124.png")],
  [#image("../media/proy1125.png")],[#image("../media/proy1126.png")],
)
Preview:
#image("../media/proy1127.png")
etl_pil.kjb:
#image("../media/proy113.png")
