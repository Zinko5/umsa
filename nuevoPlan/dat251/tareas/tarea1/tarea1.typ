...
#let fechaEntrega = datetime(year: 2025, month: 3, day: 5)
...
#grid(
    ...
    stroke: 0.4pt+ black,
    [Diagrama],[Salida],
    [#image("tr1-1.png")],[#image("tr1-2.png")],
)

== Configuracion de transformación 1
#grid(
    columns: (auto, auto),
    inset: 0.5em,
    stroke: 0.4pt+ black,
    [Kettle version],[Table output],
    [#image("tr1-3.png")], [#image("tr1-4.png", width: 90%)],
)
