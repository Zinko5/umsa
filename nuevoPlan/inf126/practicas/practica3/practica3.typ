...
#let fechaEntrega = datetime(year: 2025, month: 6, day: 20)
...
== Integrales en dos variables
=== 1. Sea $A$ el cuadrado con vértices en $(0,0), (1,0), (1,1), (0,1)$. Calcular aproximadamente el valor da la integral $integral.double_A (x^2y)d A$
#ejercicio(
  [*a)* dividiendo $A$ en dos partes],
  [$
...
=== 6. Calcular:
#ejercicio(
  [*a)* $integral.double_A x^2 d A$, siendo A el rectángulo limitado por $x=0, x=2, y=0, y=4$],
  [$
     [0,2]x, [0,4]y
   $]
)
...
#ejercicio(
  [*b)* $integral.double_A (x+2y)d A$ si $A$ es el triángulo limitado por $x=0, y=0, x+y=1$],
  [$
